...
/* cette fonction sert à trier la tableau de processus en fonction de 
...
// fonction qui exécute une processus d'un ordonnanceur à condition qu'il existe
...
/* fonction qui permet d'exécuter la fonction step pour une fille entière à condition qu'elle soit pas vide */
void run(ordo File){
	if(File == NULL){
